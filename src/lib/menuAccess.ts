...
export const SIDEBAR_MENU_ACCESS: MenuAccessItem[] = [
  ...
  { group: 'Operations', key: 'pricing', label: 'Product pricing' },
...
export const ROLE_DEFAULT_MENU_ACCESS: Record<string, string[]> = {
  ...
  FINANCE_OFFICER: ['expenses', 'processing_money', 'payroll', 'staff', 'operators', 'costs', 'overhead', 'sales', 'pricing', 'distributors', 'sales_margins', 'alerts'],
