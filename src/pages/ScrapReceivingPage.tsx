...
export function ScrapReceivingPage() {
  ...
  useEffect(() => {
    ...
    reset({
      ...
      materialId: r.material?.id ? String(r.material.id) : '',
      locationId: r.batch?.locationId ? String(r.batch.locationId) : '',
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            ...
            <Field label="Material type">
              <select
                className="dgn-input w-full"
                disabled={isEdit}
                {...register('materialId', { required: !isEdit })}
              >
              ...
              <div className="sm:col-span-2">
                <Field label="Store location">
                  <select
                    className="dgn-input w-full"
                    disabled={isEdit}
                    {...register('locationId', { required: !isEdit && !isCrushed })}
                  >
